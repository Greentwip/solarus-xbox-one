/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.33 on Mon Nov 25 10:36:05 2019.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=3.0, gles2=2.0
    Profile: core
    Extensions:
    ...
    Commandline:
        --profile="core" --api="gl=3.0,gles2=2.0" --generator="c" --spec="gl" --extensions="GL_ARB_framebuffer_object,GL_ARB_vertex_array_object"
    Online:
...
#if (defined(_WIN32) || defined(WINRT)) && !defined(APIENTRY) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__)
